...
namespace clp_loglib_native::encoder {
    PyObject* encode_preamble (PyObject* self, PyObject* args) {
        ...
        if (false == PyArg_ParseTuple(args, "Lss", &ref_timestamp, &input_timestamp_format,
            &input_timezone))
        {
        ...
        if (false == ffi::ir_stream::four_byte_encoding::encode_preamble(timestamp_format,
    ...
    PyObject* encode_message_and_timestamp (PyObject* self, PyObject* args) {
        ...
        // Encode the message
        if (false == ffi::ir_stream::four_byte_encoding::encode_message(delta, msg, logtype, 
            ir_buf)) {
