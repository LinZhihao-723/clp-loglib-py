    ...
    def _aggregator(
        ...
        with log_path.open("ab") as log:
            ...
            def log_fn(msg: str) -> None:
                ...
                buf: bytearray
                buf, last_timestamp_ms = encode_message_and_timestamp(
                    last_timestamp_ms, (msg + "\n").encode()
                )
                ostream.write(buf)
            ...
            while not CLPSockListener._signaled:
                ...
                timestamp_buff: bytearray
                timestamp_buff, last_timestamp_ms = encode_timestamp(
                    last_timestamp_ms
                )
                if loglevel_timeout:
...
class CLPStreamHandler(CLPBaseHandler):
    ...
    def _direct_write(self, msg: str) -> None:
        ...
        clp_msg: bytearray
        clp_msg, self.last_timestamp_ms = encode_message_and_timestamp(
            self.last_timestamp_ms, (msg + "\n").encode()
        )
